  ...
  const edgeType = new _graphql.GraphQLObjectType({
    ...
    fields: () => {
      ...
      return {
        ...
        ...resolveMaybeThunk((_config$edgeFields = config.edgeFields) !== null && _config$edgeFields !== void 0 ? _config$edgeFields : {})
      };
    }
  });
  const connectionType = new _graphql.GraphQLObjectType({
    ...
    fields: () => {
      ...
      return {
        ...
        ...resolveMaybeThunk((_config$connectionFie = config.connectionFields) !== null && _config$connectionFie !== void 0 ? _config$connectionFie : {})
      };
    }
  });
  return {
